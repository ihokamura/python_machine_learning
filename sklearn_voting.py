"""
show sample of how to use VotingClassifier
"""
...
def main():
    ...
    majority_vote = VotingClassifier(
        estimators=[
    ...
    classifier_names = ['logistic regression', 'decision tree', 'KNN', 'voting']
    ...
    # execute grid search
    print(majority_vote.get_params())
    param_grid = {
